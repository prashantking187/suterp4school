...
<div id="footer">
  <ul>
    <li>
      ${uiLabelMap.CommonCopyright} (c) 2009-${nowTimestamp?string("yyyy")}  <a href="http://linux.sut.ac.th/suterp/" class="noicon">SUTERP: The Enterprise Resource Planning for School.</a> - "Make today better than yesterday!."<br/>
