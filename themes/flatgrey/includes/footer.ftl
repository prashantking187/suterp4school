...
<div id="footer">
  ...
  <p>
  ${uiLabelMap.CommonCopyright} (c) 2001-${nowTimestamp?string("yyyy")} ${uiLabelMap.CommonPoweredBy} <a href="http://ofbiz.apache.org" target="_blank">Apache OFBiz:</a> 
  Modify by <a href="http://linux.sut.ac.th/suterp/" target="_blank" class="noicon">SUTERP: The Enterprise Resource Planning for School.</a> - "Make today better than yesterday!."
  <#include "ofbizhome://runtime/svninfo.ftl" />
  </p>
</div>
</div>
